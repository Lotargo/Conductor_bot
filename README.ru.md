...
- [x] **Интеграция с Redis:** Предложить опциональный бэкенд на Redis для краткосрочной памяти, чтобы обеспечить stateless, горизонтально масштабируемые развертывания.
